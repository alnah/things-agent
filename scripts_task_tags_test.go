...
func TestScriptAddTaskTags(t *testing.T) {
	...
	if !strings.Contains(got, "set existingTags to {}") || !strings.Contains(got, "set mergedTagsText to existingTags as text") {
...
func TestScriptRemoveTaskTags(t *testing.T) {
	...
	if !strings.Contains(got, "set filteredTags to {}") || !strings.Contains(got, "set filteredTagsText to filteredTags as text") {
